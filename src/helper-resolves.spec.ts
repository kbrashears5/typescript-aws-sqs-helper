...
const deleteMessageBatchResultResponse: SQS.DeleteMessageBatchResult = { Failed: [], Successful: [] };
const deleteQueueResultResponse: object = {};
const getQueueAttributesResultResponse: SQS.GetQueueAttributesResult = { Attributes: { ApproximateNumberOfMessages: '5' } };
...
const sendMessageBatchResultResponse: SQS.SendMessageBatchResult = { Failed: [], Successful: [] };
...
const deleteMessageBatch = jest.fn().mockImplementation(() => {
    return Promise.resolve<SQS.DeleteMessageBatchResult>(deleteMessageBatchResultResponse);
});
...
const getQueueAttributes = jest.fn().mockImplementation(() => {
    return Promise.resolve<SQS.GetQueueAttributesResult>(getQueueAttributesResultResponse);
});
...
const receiveMessage = jest.fn().mockImplementation(() => {
    return Promise.resolve<SQS.ReceiveMessageResult>(receiveMessageResultResponse);
});
...
const sendMessageBatch = jest.fn().mockImplementation(() => {
    return Promise.resolve<SQS.SendMessageBatchResult>(sendMessageBatchResultResponse);
});
...
describe(`${SQSHelper.name}.${sqsHelperMock.CreateQueueAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} queueName`, () => {
        ...
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} queueName`);
    });
...
describe(`${SQSHelper.name}.${sqsHelperMock.DeleteMessageAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} queueUrl`, () => {
        const actual = sqsHelperMock.DeleteMessageAsync(TestValues.EmptyString, TestValues.ReceiptHandle);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} queueUrl`);
    });
    test(`${TestValues.ThrowsOnEmpty} receiptHandle`, () => {
        const actual = sqsHelperMock.DeleteMessageAsync(TestValues.Url, TestValues.EmptyString);
...
describe(`${SQSHelper.name}.${sqsHelperMock.DeleteMessagesAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} queueUrl`, () => {
        const actual = sqsHelperMock.DeleteMessagesAsync(TestValues.EmptyString, [TestValues.ReceiptHandle]);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} queueUrl`);
    });
    test(`${TestValues.ThrowsOnEmpty} receiptHandles`, () => {
        const actual = sqsHelperMock.DeleteMessagesAsync(TestValues.Url, TestValues.EmptyArray);
    ...
    test(`${TestValues.ThrowsOnTooMany} receiptHandles`, () => {
        const actual = sqsHelperMock.DeleteMessagesAsync(TestValues.Url, [TestValues.StringValue, TestValues.StringValue, TestValues.StringValue, TestValues.StringValue, TestValues.StringValue, TestValues.StringValue, TestValues.StringValue, TestValues.StringValue, TestValues.StringValue, TestValues.StringValue, TestValues.StringValue]);
...
describe(`${SQSHelper.name}.${sqsHelperMock.GetNumberOfMessagesOnQueueAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} queueUrl`, () => {
        const actual = sqsHelperMock.GetNumberOfMessagesOnQueueAsync(TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} queueUrl`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${SQSHelper.name}.${sqsHelperMock.GetQueueAttributesAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} queueUrl`, () => {
        const actual = sqsHelperMock.GetQueueAttributesAsync(TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} queueUrl`);
    });
    test(TestValues.ValidTest, () => {
        const actual = sqsHelperMock.GetQueueAttributesAsync(TestValues.Url);
        return expect(actual).resolves.toBe(getQueueAttributesResultResponse.Attributes);
    });
});
...
describe(`${SQSHelper.name}.${sqsHelperMock.SendMessageAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} queueUrl`, () => {
        const actual = sqsHelperMock.SendMessageAsync(TestValues.EmptyString, TestValues.Body);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} queueUrl`);
    });
    test(`${TestValues.ThrowsOnEmpty} messageBody`, () => {
        const actual = sqsHelperMock.SendMessageAsync(TestValues.Url, TestValues.EmptyString);
...
describe(`${SQSHelper.name}.${sqsHelperMock.SendMessagesAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} queueUrl`, () => {
        const actual = sqsHelperMock.SendMessagesAsync(TestValues.EmptyString, TestValues.Entries);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} queueUrl`);
    });
    test(`${TestValues.ThrowsOnEmpty} entries`, () => {
        const actual = sqsHelperMock.SendMessagesAsync(TestValues.Url, TestValues.EmptyArray);
